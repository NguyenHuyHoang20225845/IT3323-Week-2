...
typedef enum {
  ...
  KW_FUNCTION, KW_PROCEDURE, KW_BEGIN, KW_END,
  KW_CALL, KW_IF, KW_THEN, KW_ELSE,
  ...
  SB_ASSIGN, SB_EQ, SB_NEQ, SB_LT, SB_LE,
  SB_GT, SB_GE, SB_PLUS, SB_MINUS,
  SB_TIMES, SB_SLASH, SB_MOD, SB_POW, // thêm SB_MOD, SB_POW
